        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 bg-slate-700 border rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 ${
                errors.title ? 'border-red-500 focus:ring-red-500' : 'border-slate-600 focus:ring-purple-500'
              }`}
            />
          ...
          <div>
            ...
            <input
              ...
              placeholder="0.00"
              className={`w-full px-3 py-2 bg-slate-700 border rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 ${
                errors.amount ? 'border-red-500 focus:ring-red-500' : 'border-slate-600 focus:ring-purple-500'
              }`}
            />
          ...
          <div>
            ...
            <select
              ...
              className={`w-full px-3 py-2 bg-slate-700 border rounded-lg text-white focus:outline-none focus:ring-2 cursor-pointer ${
                errors.account ? 'border-red-500 focus:ring-red-500' : 'border-slate-600 focus:ring-purple-500'
              }`}
            >
          ...
          <div>
            ...
            <select
              ...
              className={`w-full px-3 py-2 bg-slate-700 border rounded-lg text-white focus:outline-none focus:ring-2 cursor-pointer ${
                errors.transactionType ? 'border-red-500 focus:ring-red-500' : 'border-slate-600 focus:ring-purple-500'
              }`}
            >
          ...
          <div>
            ...
            <select
              ...
              className={`w-full px-3 py-2 bg-slate-700 border rounded-lg text-white focus:outline-none focus:ring-2 cursor-pointer ${
                errors.category ? 'border-red-500 focus:ring-red-500' : 'border-slate-600 focus:ring-purple-500'
              }`}
            >
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-purple-500 cursor-pointer"
            >
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 bg-slate-700 border rounded-lg text-white focus:outline-none focus:ring-2 ${
                errors.startDate ? 'border-red-500 focus:ring-red-500' : 'border-slate-600 focus:ring-purple-500'
              }`}
            />
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 bg-slate-700 border rounded-lg text-white focus:outline-none focus:ring-2 ${
                errors.endDate ? 'border-red-500 focus:ring-red-500' : 'border-slate-600 focus:ring-purple-500'
              }`}
            />
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              className="flex-1 px-4 py-2 bg-purple-500 hover:bg-purple-700 text-white rounded-lg font-medium transition-colors"
            >
