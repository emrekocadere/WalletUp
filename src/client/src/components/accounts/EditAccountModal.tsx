        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button type="submit" className="flex-1 px-4 py-2.5 bg-violet-500 hover:bg-violet-700 rounded-lg font-semibold text-white transition-all shadow-lg shadow-violet-500/30">
