          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2 text-[10px] text-gray-400">
                <span className="px-2 py-0.5 rounded-full border border-purple-500/30 bg-purple-500/10 text-purple-300 hover:border-purple-400/50 transition-all">{tx.category?.id || t('accountTransactionsPanel.category')}</span>
