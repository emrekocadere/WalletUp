        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12 pt-16 lg:pt-12">
          ...
          <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row justify-end gap-3">
            ...
            <button
              onClick={handleSave}
              disabled={isLoading}
              className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-purple-500 hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm sm:text-base font-semibold rounded-xl transition-colors"
            >
